...
const PaginationContent = React.forwardRef<HTMLLIElement, React.ComponentProps<"ul">>(
  ({ className, ...props }, ref) => (
    <ul ref={ref} className={cn("flex flex-row items-center gap-0.5 sm:gap-1", className)} {...props} />
  ),
);
