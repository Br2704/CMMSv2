  ...
  return (
    <PageShell>
      ...
      <Tabs defaultValue="dashboard" className="space-y-4">
        <TabsList className="flex w-full flex-nowrap overflow-x-auto"><TabsTrigger value="dashboard" className="whitespace-nowrap">Dashboard</TabsTrigger><TabsTrigger value="data" className="whitespace-nowrap">Data Entry</TabsTrigger><TabsTrigger value="analytics" className="whitespace-nowrap">Analytics</TabsTrigger><TabsTrigger value="reports" className="whitespace-nowrap">Reports</TabsTrigger></TabsList>
