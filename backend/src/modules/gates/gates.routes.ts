...
gatesRouter.post('/gates', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
...
gatesRouter.patch('/gates/:id', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
    const params = z.object({ id: z.string().uuid() }).parse(req.params);
...
gatesRouter.delete('/gates/:id', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
    const params = z.object({ id: z.string().uuid() }).parse(req.params);
    const repo = AppDataSource.getRepository(GateEntity);
    const entity = await repo.findOneBy({ id: params.id });
...
gatesRouter.post('/gate-templates', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
...
gatesRouter.patch('/gate-templates/:id', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
    const params = z.object({ id: z.string().uuid() }).parse(req.params);
...
gatesRouter.delete('/gate-templates/:id', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
    const params = z.object({ id: z.string().uuid() }).parse(req.params);
    const repo = AppDataSource.getRepository(GateEntryTypeEntity);
    const entity = await repo.findOneBy({ id: params.id });
...
gatesRouter.post('/gate-templates/:id/fields', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
    const params = z.object({ id: z.string().uuid() }).parse(req.params);
...
gatesRouter.patch('/gate-template-fields/:id', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
    const params = z.object({ id: z.string().uuid() }).parse(req.params);
...
gatesRouter.delete('/gate-template-fields/:id', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
    const params = z.object({ id: z.string().uuid() }).parse(req.params);
    const repo = AppDataSource.getRepository(GateTemplateFieldEntity);
    const entity = await repo.findOneBy({ id: params.id });
...
gatesRouter.post('/gate-templates/:id/users', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
    const params = z.object({ id: z.string().uuid() }).parse(req.params);
...
gatesRouter.patch('/gate-template-users/:id', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
    const params = z.object({ id: z.string().uuid() }).parse(req.params);
...
gatesRouter.delete('/gate-template-users/:id', requireRole(['SUPERADMIN', 'ADMIN']), async (req, res, next) => {
  try {
    const params = z.object({ id: z.string().uuid() }).parse(req.params);
    const repo = AppDataSource.getRepository(GateTemplateUserEntity);
    const entity = await repo.findOneBy({ id: params.id });
